/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4fa106740d7779cf4057f1240d69db3a)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLERK_SIGN_IN_FALLLBACK_REDIRECT_URL: string;
		CLERK_SIGN_UP_FALLLBACK_REDIRECT_URL: string;
		ASSETS: Fetcher;
	}
}
